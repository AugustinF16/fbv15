...
@media(max-width:620px){.settingsPalette{grid-template-columns:repeat(5,30px);}.settingsPanel{width:calc(100vw - 24px);}}
...
<main class="page">
  ...
  <footer class="footer" id="disclaimer">Statistical short-setup research only. Levels are conditional and are not guaranteed outcomes.</footer>
</main>
<script>
