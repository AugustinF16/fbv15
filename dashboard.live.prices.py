...
.legalFooter{margin:0 26px 26px;padding:15px 0 0;border-top:1px solid var(--theme-line,var(--line));color:var(--theme-muted,var(--muted));font-size:9.5px;line-height:1.55;text-align:center}
.legalFooter strong,.legalCopyright{color:var(--theme-text,var(--text));font-weight:750}
.legalFooter p{max-width:1100px;margin:5px auto 0}
...
function openSelectedAnalysisSheet(){
  ...
  win.document.close();
  const selectedLegalStyle=win.document.createElement('style');
  selectedLegalStyle.textContent='.legalFooter{text-align:center}.legalFooter p{max-width:980px;margin:5px auto 0}';
  win.document.head.appendChild(selectedLegalStyle);
...
.legalFooter{text-align:center}.legalFooter p{max-width:1100px;margin:5px auto 0}
</style>
